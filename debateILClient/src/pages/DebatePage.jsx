...
export default function DebatePage() {
  ...
  const audience = useMemo(() => {
    ...
    if (currentUser) {
      if (!audienceMembers.find((member) => member.id === currentUser.id)) {
        audienceMembers.push({
          id: currentUser.id,
      ...
      // Show a guest placeholder for viewers without an account
      audienceMembers.push({ id: "guest-self", isGuest: true });
    }
  ...
  const handleAddArgument = useCallback(
    async (e) => {
      ...
      // Check for bad words
      if (containsBadWords(sanitizedArgument)) {
        setErrorMessage("Your message contains inappropriate content. Please revise your message and try again.");
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200/50 sticky top-0 z-50">
        ...
        <button
          onClick={() => navigate("/")}
              className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition-all duration-200 hover:scale-105 shadow-sm"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              {debate?.status === "finished" && (
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg">
                  ...
                  <span className="text-sm font-semibold text-gray-700">FINISHED</span>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="text-center mb-4">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
        ...
        {currentUser && (currentUser.id === user1?.id || currentUser.id === user2?.id) && (
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-4 mb-4">
            <form onSubmit={handleAddArgument} className="flex gap-3">
            ...
            <input
              ...
              onChange={(e) => setNewArgument(e.target.value)}
                  ...
                  className="w-full px-4 py-3 pr-10 rounded-lg border-2 border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-100 transition-all duration-200 text-gray-800 placeholder-gray-500 shadow-sm"
                />
            ...
            <button
              ...
              disabled={isSubmittingArgument}
                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-purple-500/25 hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center gap-2"
              >
          ...
          {debate?.status === "finished" && (
            <div className="flex justify-center mt-3">
                <div className="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg shadow-lg flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 10a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z" />
                  </svg>
